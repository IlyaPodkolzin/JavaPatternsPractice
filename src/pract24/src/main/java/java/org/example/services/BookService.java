...
import java.org.example.specifications.BookSpecification;
...
public class BookService {
    ...
    public List<BookDto> findByFilter(Book book) {
        ...
        Specification<Book> filters = Specification
                .where(book.getName() == null ? null : BookSpecification.nameLike(book.getName()))
                .and(book.getCreationDate() == null ? null : BookSpecification.creationDateLike(book.getCreationDate()))
                .and(book.getAuthorId() == null ? null : BookSpecification.authorIdIs(book.getAuthorId()));
